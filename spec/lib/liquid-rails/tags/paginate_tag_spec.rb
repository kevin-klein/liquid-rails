...
module Liquid
  module Rails
    describe PagyNextLinkTag, type: :tag do
      ...
      context 'first_page' do
        it 'returns the page size' do
          pagy, _items = pagy_array([@post_drop])

          expect_template_result("{% pagy_next_link pagy 'MEHR LADEN' 'id=some-id' %}", '<span class="page next disabled">MEHR LADEN</span>', { 'pagy' => pagy })
        end
